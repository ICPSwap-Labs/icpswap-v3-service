...
module {
    ...
    public type SwapPoolMsg = {
        #activeJobs : () -> ();
        #addLimitOrder : () -> (args : LimitOrderArgs);
        #allTokenBalance : () -> (offset : Nat, limit : Nat);
        #approvePosition : () -> (spender : Principal, positionId : Nat);
        #batchRefreshIncome : () -> (positionIds : [Nat]);
        ...
        #depositAllAndMint : () -> (args : DepositAndMintArgs);
        #depositAndSwap : () -> (args : DepositAndSwapArgs);
        #depositFrom : () -> (args : DepositArgs);
        #depositFromAndSwap : () -> (args : DepositAndSwapArgs);
        #getAdmins : () -> ();
        ...
        #getLimitOrderStack : () -> ();
        #getLimitOrders : () -> ();
        #getMistransferBalance : () -> (token : Token);
        #getPosition : () -> (args : GetPositionArgs);
        ...
        #getTokenBalance : () -> ();
        #getTransactions : () -> ();
        #getTransactionsByOwner : () -> (owner : Principal);
        #getUserByPositionId : () -> (positionId : Nat);
        #getUserLimitOrders : () -> (user : Principal);
        #getUserPosition : () -> (positionId : Nat);
        #getUserPositionIds : () -> ();
        #getUserPositionIdsByPrincipal : () -> (owner : Principal);
        #getUserPositionWithTokenAmount : () -> (offset : Nat, limit : Nat);
        ...
        #init : () -> (fee : Nat, tickSpacing : Int, sqrtPriceX96 : Nat);
        #metadata : () -> ();
        #mint : () -> (args : MintArgs);
        #quote : () -> (args : SwapArgs);
        #quoteForAll : () -> (args : SwapArgs);
        ...
        #swap : () -> (args : SwapArgs);
        #transferPosition :
          () -> (from : Principal, to : Principal, positionId : Nat);
        #updateTokenFee : () -> ();
        #upgradeTokenStandard : () -> (tokenCid : Principal);
        #withdraw : () -> (args : WithdrawArgs);
        #withdrawMistransferBalance : () -> (token : Token);
